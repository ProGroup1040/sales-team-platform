...
## UI Optimization (Dark Mode Fix)
- [ ] خلفية ثابتة #0B1D2A بدون glass/blur/transparency
- [ ] كروت Solid Dark Gray/Navy مع Shadow خفيف
- [ ] Primary Text: #FFFFFF صريح، Secondary: #B0B0B0
- [ ] أرقام KPI Bold وأكبر
- [ ] ألوان Status واضحة (أخضر مضيء، أحمر قوي، أصفر واضح)
- [ ] فصل الأقسام بمسافات واضحة
- [ ] إزالة كل Glass/Blur/Transparency الزائدة

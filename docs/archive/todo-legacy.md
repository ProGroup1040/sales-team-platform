...
- [x] Fix 1: إضافة زر "تعديل" بجانب كل مهندس (تغيير القسم + نوع المهندس)
...
## Project Timeline — متابعة المشاريع من التعاقد إلى الإغلاق النهائي
- [x] فحص واستيعاب المتطلبات وربط Project Timeline بالصفقات المغلقة الحالية دون إنشاء نظام مستقل
- [x] إضافة جداول إعدادات مراحل المشروع وSLA قابلة للتعديل من الواجهة
- [x] إضافة سجل مشاريع مرتبط بالصفقات المغلقة يتضمن العقد والعميل والمهندس والتسليم المتفق عليه والحالة الحالية
- [x] إضافة Project Movement Log تاريخي لكل انتقال بين الإدارات مع التواريخ المخططة والفعلية والاستلام والتسليم
- [x] إضافة Delay Ledger لتصنيف كل أيام التأخير حسب الجهة والشخص والسبب
- [x] إضافة إعدادات Delay Owners وReason Codes مع دعم Other وإلزام الملاحظات
- [x] إضافة نظام On Hold بتواريخ وسبب ومسؤول وموعد استئناف متوقع
- [x] بناء حساب تلقائي لحالة المشروع: On Time / At Risk / Delayed / Critical Delay / On Hold / Completed / Closed
- [x] بناء APIs لإدارة المشاريع والمراحل والحركات والتأخيرات ودفتر التأخيرات
- [x] بناء صفحة Project Timeline مع قائمة مشاريع وفلاتر وإحصاءات وتنبيهات
- [x] بناء صفحة تفصيل المشروع مع المسار الزمني وسجل الحركات ودفتر التأخيرات
- [x] ربط الموديول بالصفقات المغلقة ومؤشرات التقارير دون تعديل الـ Workflow الحالي
- [x] إضافة اختبارات Vitest لمنطق SLA والحركة والتأخيرات وOn Hold
- [x] حساب الحالة والتأخير وUpdate Compliance ديناميكياً عند العرض دون انتظار إدخال المستخدم
- [x] إضافة تحليلات الإدارة: أداء الإدارات، Handover Compliance، دورة المشروع، وتأخير مهندسي المبيعات
- [x] إضافة Widget للمشاريع الحرجة وتنبيهات التحديثات المفقودة
- [x] إضافة تقارير CSV قابلة للتنزيل وطباعة الصفحة إلى PDF
- [x] إضافة استيراد Excel / CSV تاريخي مع معاينة ومطابقة برقم المشروع أو العقد ومنع التكرار
- [ ] استيراد ملف Time Line الفعلي بعد رفعه وترحيل سجلاته التاريخية

## Project Timeline — استبعاد المشاريع المكتملة
- [x] استبعاد المشاريع المكتملة من قائمة Project Timeline وجميع الفلاتر والحسابات والتنبيهات مع السماح بعودتها إذا أعيد فتحها تشغيلياً

## Project Timeline — Pre-Execution وبداية التنفيذ الفعلية
- [x] إضافة حالة Pre-Execution وفصل تاريخ التعاقد عن Execution Start Date وعداد التسليم التنفيذي
- [x] إضافة بيانات Site Ready ومصدرها وسجل المعاينة التنفيذية وحالة الانتظار
- [x] بدء SLA وTarget Delivery من Execution Start Date فقط، مع عدم احتساب انتظار العميل كتأخير على الشركة
...
## Project Timeline — Historical Tracking
- [x] حفظ Snapshot تلقائي كامل عند كل تحديث مع الفرق في التأخير عن آخر تحديث
...
## Project Timeline — إعادة الفتح الاستثنائية
- [ ] إضافة إجراء موثق لإعادة فتح مشروع Completed أو Closed إلى مرحلة تشغيلية محددة
- [ ] استعادة المتابعة التشغيلية وSLA والتحديثات للمشروع مع سجل تدقيق يوضح سبب إعادة الفتح

## Project Timeline — صلاحيات العرض والتحكم
- [x] قصر جميع إجراءات تعديل Project Timeline في Backend على Admin وAdmin Sales فقط
- [x] إخفاء جميع أزرار وإجراءات التعديل في الواجهة عن بقية الأدوار مع إبقاء العرض المتاح لها
- [x] إضافة دور المستخدم إلى سجل التدقيق لكل عملية تعديل واختبارات منع التعديل المباشر لغير المصرح لهم

## Project Timeline — مساواة Admin Sales مع Admin Pro Group
- [x] إتاحة كل أدوات الإدارة ومزامنة الصفقات المغلقة والاستيراد وإعدادات المراحل لـ Admin Sales داخل Project Timeline فقط
- [x] توحيد Backend/API وواجهة Project Timeline بحيث يكون Admin وAdmin Sales متطابقين وظيفياً مع بقاء باقي الأدوار للعرض فقط
